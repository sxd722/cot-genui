...
card_0 = GeneratedCard("evidence", "证据", [evidence_body], "data", "balanced")
card_1 = GeneratedCard("tradeoff", "方案比较", [tradeoff_body], "comparison", "balanced")
evidence_body = Stack([evidence_image, evidence_table], "column", "m")
evidence_image = AssetImage("asset_evidence_1", "现场证据", "wide")
evidence_table = Table([metric_col, value_col])
