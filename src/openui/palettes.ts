...
export const COMPACT_PALETTES: Record<CompactPaletteName, OpenUIPalette> = {
  ...
  analysis: { name: "analysis", components: ["CardDeck", "GeneratedCard", "TextContent", "Stack", "Callout", "TagBlock", "Table", "Col", "MetricRow", "BarChart", "LineChart", "AreaChart", "PieChart", "Series", "Slice", "ComparisonGrid", "ActionPanel", "HostActionChip", "HostActionItem", "Separator", "Card", "CardHeader"] },
};
